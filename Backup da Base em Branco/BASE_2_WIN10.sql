CREATE DATABASE  IF NOT EXISTS `scoult` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `scoult`;
-- MySQL dump 10.13  Distrib 5.7.9, for Win32 (AMD64)
--
-- Host: localhost    Database: scoult
-- ------------------------------------------------------
...
CREATE TABLE `tbscoutatleta` (
  ...
  `Cod_Atleta_Scoult` int(11) NOT NULL,
  `Cod_Partida_Scoult` int(11) NOT NULL,
  PRIMARY KEY (`Cod_Scout`),
  KEY `FK_Cod_Atleta_idx` (`Cod_Atleta_Scoult`),
  KEY `FK_Cod_Partida_Scoult_idx` (`Cod_Partida_Scoult`),
  CONSTRAINT `FK_Cod_Atleta` FOREIGN KEY (`Cod_Atleta_Scoult`) REFERENCES `tbatleta` (`Cod_Atleta`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_Cod_Partida_Scoult` FOREIGN KEY (`Cod_Partida_Scoult`) REFERENCES `tbpartida` (`Cod_Partida`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-03-10 15:51:58
