...
#ifndef untNovaPartidaH
#define untNovaPartidaH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class TfrmNovaPartida : public TForm
{
__published:	// IDE-managed Components
	...
	TEdit *edtGTotal;
	TEdit *edtTime;
	TBitBtn *btnAlteraTime;
	TBitBtn *btnSalvarScout;
	TBitBtn *btnFechar;
	void __fastcall FormShow(TObject *Sender);
	void __fastcall btnAlteraTimeClick(TObject *Sender);
	...
	void __fastcall edtAdversarioMouseUp(TObject *Sender, TMouseButton Button, TShiftState Shift, int X, int Y);
	void __fastcall edtLocalPartidaMouseUp(TObject *Sender, TMouseButton Button, TShiftState Shift, int X, int Y);
	void __fastcall btnFecharClick(TObject *Sender);
private:	// User declarations
public:
	int NAtletas;
	// User declarations
	__fastcall TfrmNovaPartida(TComponent* Owner);
};
//---------------------------------------------------------------------------
extern PACKAGE TfrmNovaPartida *frmNovaPartida;
//---------------------------------------------------------------------------
#endif
